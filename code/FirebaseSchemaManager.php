...
/**
 * Firebase schema manager
 *
 * @package sapphire
 * @subpackage model
 */
class FirebaseSchemaManager extends DBSchemaManager
{
    /**
    ...
    {
        if (FirebaseDatabase::model_schema_as_database()) {
    ...
    /*
     * Creates an ALTER expression for a column in Firebase
     *
    ...
    protected function getIndexSqlDefinition($tableName, $indexName, $indexSpec)
    {
        ...
        switch ($indexSpec['type']) {
            case 'fulltext':
                ...
                $clusterMethod = FirebaseDatabase::default_fts_cluster_method();
     ...
     * For Firebase, we simply return the word 'timestamp', no other parameters are necessary
     *
     * @param array $values Contains a tokenised list of info about this data type
     * @return string
     */
    ...
    /**
     * Create a fulltext search datatype for Firebase
    ...
    protected function fulltext($this_index, $tableName, $name)
    {
        ...
        $language = FirebaseDatabase::search_language();
